...
批注用于传统文化研究与娱乐，必须展示推导依据并使用“较容易、可留意、建议”等非确定性措辞。正文必须实际引用大限宫、流年宫、宫内主星及流年禄权科忌，不能只套十二宫通用模板。
...
- 批注正文分为十年气候、今年落点、四化怎么走、卡点在哪、落地判断
- 宫内有主星时点名主星及传统性情；无十四主星时明确说明需要结合对宫和四化
